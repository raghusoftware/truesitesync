...
import { loadUserOrg, loadOrgMembers, loadOrgInvites, renderOrgSettings, createOrganization, bindOrgWindowFunctions, getCurrentOrg } from './modules/organization.js?v=1.3.13';
...
} from './modules/planning.js?v=1.3.25';
import {
...
import { renderPettyCash } from './modules/pettyCash.js?v=1.0.1';
...
import { createNewEstimate, closeEstimateEditor, addEstimateRow, saveEstimate, renderEstimatesList } from './modules/estimate.js?v=1.1.4';
...
import './modules/units.js?v=1.0.0';
import './modules/itemsMaster.js?v=1.0.0';
...
import { renderPurchaseLedger, clearPurchaseLedgerFilters, viewPurchaseBill, deletePurchaseBill, openPurchaseFormPanel, closePurchaseFormPanel, addPurchaseRowToPanel, updatePanelRowNums, calcPanelPurchaseTotal, savePanelPurchaseBill } from './modules/purchase.js?v=1.0.4';
import { renderPartiesList, renderPartyTransactions, selectParty, _editParty, _deleteParty } from './modules/parties.js?v=1.0.5';
...
} from './modules/settings.js?v=1.3.26';
import {
  ...
  computeProjectPnL
} from './modules/microPlanning.js?v=1.4.29';
...
function _bootApp() {
  ...
  // Re-apply any pending soft-deletes (Recycle Bin) that a prior sync may have
  // resurrected in a source array.
  try { window.reconcileRecycleBin?.(); } catch (e) { console.warn('[boot] recycle reconcile failed:', e); }
