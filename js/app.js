...
} from './modules/planning.js?v=1.3.26';
import {
...
import { renderIssues } from './modules/issues.js?v=1.3.23';
...
import './modules/mobileShell.js?v=1.5.1';
...
import './modules/executionEngine.js?v=1.0.0';
...
import { renderPurchaseLedger, clearPurchaseLedgerFilters, viewPurchaseBill, deletePurchaseBill, openPurchaseFormPanel, closePurchaseFormPanel, addPurchaseRowToPanel, updatePanelRowNums, calcPanelPurchaseTotal, savePanelPurchaseBill } from './modules/purchase.js?v=1.0.5';
...
} from './modules/settings.js?v=1.3.29';
import {
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    installPdfMonochrome();
  } catch (e) {
    console.error('[boot] installPdfMonochrome failed:', e);
  }
