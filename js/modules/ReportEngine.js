  ...
  _inferColumns(data, dataSource) {
    ...
    const columnDefs = {
      ...
      dailyProgress: [
        ...
        { key: 'manpowerSkilled', label: 'Skilled', type: 'number' },
        { key: 'manpowerUnskilled', label: 'Unskilled', type: 'number' },
        { key: 'weather', label: 'Weather', type: 'text' },
        { key: 'hindrance', label: 'Hindrance', type: 'text' },
      ],
      concretePours: [
        { key: 'pourNo', label: 'Pour No', type: 'text' },
        { key: 'date', label: 'Date', type: 'date' },
        { key: 'element', label: 'Element', type: 'text' },
        { key: 'grade', label: 'Grade', type: 'text' },
        { key: 'volume', label: 'Vol (m³)', type: 'number' },
        { key: 'location', label: 'Location', type: 'text' },
        { key: 'slump', label: 'Slump', type: 'number' },
        { key: 'cubes', label: 'Cubes', type: 'number' },
        { key: 'supplier', label: 'RMC Vendor', type: 'text' },
        { key: 'status', label: 'Status', type: 'badge' },
      ],
      pettyCashTxns: [
        { key: 'date', label: 'Date', type: 'date' },
      ...
      projects: [
        ...
        { key: 'status', label: 'Status', type: 'badge' },
        { key: 'budget', label: 'WO Value', type: 'currency' },
      ],
    };
