...
const STORAGE_KEYS = {
  ...
  changeOrders: 'mes_change_orders',
  ...
  staffMaster: 'mes_staff_master',
  staffAttendance: 'mes_staff_attendance',
  ...
  scheduleLocations: 'mes_schedule_locations' // drag-drop location-wise task schedule
};
...
export const state = {
  ...
  changeOrders: load(STORAGE_KEYS.changeOrders, []),
  ...
  staffMaster: load(STORAGE_KEYS.staffMaster, []),
  staffAttendance: load(STORAGE_KEYS.staffAttendance, []),
  ...
  rbacFlags: load(STORAGE_KEYS.rbacFlags, {}),
  ...
  scheduleLocations: load(STORAGE_KEYS.scheduleLocations, []),
...
function _renderForKeys(keys) {
  ...
  const map = {
    ...
    saleInvoices: ['renderSaleInvoices', 'renderSalesLedger', 'renderPartiesList', 'renderCashFlow'],
    invoices: ['renderInvoiceHistory', 'renderPartiesList', 'renderCashFlow'],
    abstracts: ['renderAbstractsList', 'renderPartiesList', 'renderCashFlow'],
    changeOrders: ['renderRABilling'],
    paymentsIn: ['renderPaymentInList', 'renderPartiesList', 'renderCashFlow'],
    vendors: ['renderVendorLedger', 'renderPartiesList'],
    vendorMaterials: ['renderVendorLedger', 'renderPartiesList', 'renderCashFlow'],
    vendorPayments: ['renderVendorLedger', 'renderPartiesList', 'renderCashFlow'],
    labourMaster: ['renderLabourMasterList', 'renderMonthlyMuster', 'renderPartiesList'],
    attendanceLogs: ['renderMonthlyMuster'],
    labourPayments: ['renderPartiesList', 'renderCashFlow'],
    accounts: ['renderAccounts'],
    expenses: ['renderExpenseCategories', 'renderCashFlow'],
    issues: ['renderIssues'],
    ...
    scheduleLocations: ['renderScheduleBuilder'],
  };
  const seen = new Set();
...
export function migrateToProjects() {
  ...
  const arrKeys = ['clients','estimates','sheets','abstracts','invoices','paymentsIn','expenses',
    ...
    'execActivities','execBaselines','execPlans','execChanges','execActuals','execAssignments','scheduleLocations'];
  arrKeys.forEach(key => {
